...
public class TestTwoResizes {
   ...
   /**
    ...
    public void testUpdateArray() {
        ...
        pairs[0] = new Pair("Key 5", 1);
        pairs[1] = new Pair("Key", SIZE);
        d.update(pairs);
        assertEquals("Tamaño incorrecto", SIZE + 1, d.length());
        assertEquals(1, d.get("Key 5"));
        assertEquals(SIZE, d.get("Key"));
    }
    ...
    public void testMerge() {
        ...
        assertEquals(6, d3.get("Key 6"));
        assertEquals(10, d3.get("Key 10"));
    ...
    public void testContains() {
        ...
        assertTrue(d.contains("Key 5"));
        assertTrue(d.contains("Key 7"));
        assertTrue(d.contains("Key 11"));
